...
**Cloud:** AWS · Azure · GCP · Hetzner · Oracle Cloud
**IaC & Config:** Terraform · Pulumi · Ansible
**Containers & Orchestration:** Kubernetes (EKS, k3s) · Docker · Docker Swarm
...
I build and operate real, production-grade SaaS products on my own infrastructure:

- **[CVJudge](https://cvjudge.com)** — AI-powered CV review (credit-based, Next.js + Vercel + Supabase).
- **[DevopsFriend](https://devopsfriend.com)** — AI DevOps assistant (Next.js + Oracle Cloud backend + Supabase).
...
📍 Ho Chi Minh City, Vietnam · 🎓 Computer Engineering, HCMUT · 🗣️ TOEIC 860
